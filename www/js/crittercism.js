...
if (!window.cordova && !window.Crittercism) {
	...
	Crittercism = {
		...
		logHandledException: function(exception) {
				//cordova.exec(success, fail, "CDVCrittercism", "crittercismLogHandledException", [exception]);
		},
	...
	*/
	...
	if (!window.Crittercism) {
		console.log("Crittercism not initialized!");
	}
}
